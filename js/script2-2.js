...
$('.note').hover(
    function () {
        $(this).attr('src', './img/1note_hover.png');
    },
    function () {
        $(this).attr('src', './img/explore_pd1.png');
    }
);
$('.calender').hover(
    function () {
        $(this).attr('src', './img/2calender_hover.png');
    },
    function () {
        $(this).attr('src', './img/explore_pd2.png');
    }
);
$('.ticket').hover(
    function () {
        $(this).attr('src', './img/3ticket_hover.png');
    },
    function () {
        $(this).attr('src', './img/explore_pd3.png');
    }
);
$('.carabiner').hover(
    function () {
        $(this).attr('src', './img/4carabiner_hover.png');
    },
    function () {
        $(this).attr('src', './img/explore_pd4.png');
    }
);
$('.linenbag').hover(
    function () {
        $(this).attr('src', './img/5bag_hover.png');
    },
    function () {
        $(this).attr('src', './img/explore_pd5.png');
    }
);
...
$('.bag').click(function () {
    ...
    if ($(this).hasClass('active')) {
        ...
        $(this).attr('src', './img/icon_bag_on.png');

    } else {

        $(this).attr('src', './img/icon_bag_off.png');
