...
$(function () {
    ...
    $(".close_icon").click(function () {
        $(".join_box").fadeOut();
        $(".join").attr("src", "img/join_icon.png");
    });
    // 조인 아이콘 변하게
    $(".join").mouseenter(function () {
        $(this).attr("src", "img/join_icon_hover.png");//변경될 이미지 주소를 넣어주세요
    });
});
...
$(function () {
    ...
    $(".green1").mouseenter(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map1")
            .attr("src", "img/통영_중급.jpg");
    });
    $(".green1").mouseleave(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map1")
            .attr("src", "img/통영_off.jpg");
...
$(function () {
    ...
    $(".blue2").mouseenter(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map2")
            .attr("src", "img/여수_초급.jpg");
    });
    $(".blue2").mouseleave(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map2")
            .attr("src", "img/여수_off.jpg");
    });
...
$(function () {
    ...
    $(".blue3").mouseenter(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map3")
            .attr("src", "img/인천_초급.jpg");
    });
    $(".blue3").mouseleave(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map3")
            .attr("src", "img/인천_off.jpg");
    });
    ...
    $(".green3").mouseenter(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map3")
            .attr("src", "img/인천_중급.jpg");
    });
    $(".green3").mouseleave(function () {
        $(this)
            .closest(".map_wrap")
            .find(".map3")
            .attr("src", "img/인천_off.jpg");
...
$(function () {
    $(".product_tap>li").click(function () {
        $(this).addClass("product_on")
            .siblings().removeClass("product_on");
    });
});

// journal 저널=======================================================================호버 시 이미지 변경================================

$(function () {
    // 1
    $(".img1,.title_box1").mouseenter(function () {
        $(".img1").attr("src", "img/journal1.png");
    });
    $(".img1,.title_box1").mouseleave(function () {
        $(".img1").attr("src", "img/journal1_bw.png");
    });
    // 2
    $(".img2,.title_box2").mouseenter(function () {
        $(".img2").attr("src", "img/journal2.png");
    });
    $(".img2,.title_box2").mouseleave(function () {
        $(".img2").attr("src", "img/journal2_bw.png");
    });
    // 3
    $(".img3,.title_box3").mouseenter(function () {
        $(".img3").attr("src", "img/journal3.png");
    });
    $(".img3,.title_box3").mouseleave(function () {
        $(".img3").attr("src", "img/journal3_bw.png");
    });
    // 4
    $(".img4,.title_box4").mouseenter(function () {
        $(".img4").attr("src", "img/journal4.png");
    });
    $(".img4,.title_box4").mouseleave(function () {
        $(".img4").attr("src", "img/journal4_bw.png");
    });
    // 5
    $(".img5,.title_box5").mouseenter(function () {
        $(".img5").attr("src", "img/journal5.png");
    });
    $(".img5,.title_box5").mouseleave(function () {
        $(".img5").attr("src", "img/journal5_bw.png");
    });
});
