...
$(function () {
    ...
    $(".title_wrap > li").click(function (e) {
        $(this)
            .addClass("on_map")
            .siblings()
            .removeClass("on_map");
...
$('.heart').click(function () {
    ...
    if ($(this).hasClass('active')) {
        ...
        $(this).attr('src', './img/icon_heart_on.png');

    } else {

        $(this).attr('src', './img/icon_heart_off.png');
...
$('.sound').click(function () {
    ...
    if ($(this).hasClass('active')) {
        ...
        $(this).attr('src', './img/icon_sound_on.png');

    } else {

        $(this).attr('src', './img/icon_sound_off.png');
